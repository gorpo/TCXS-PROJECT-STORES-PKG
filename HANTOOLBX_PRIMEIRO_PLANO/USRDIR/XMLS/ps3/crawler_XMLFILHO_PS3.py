...
with open(f"{imagens[0][0:-4]}.xml",'a') as arquivo:
    ...
    for i in  range(len(links)):
        ...
        texto1 = f"""
            ...
            <Table key="tcxs_{i}">
                <Pair key="icon"><String>/dev_hdd0/game/HANTOOLBX/USRDIR/IMAGES/ps3/{imagem}</String></Pair>
        ...
        <View id="tcxs_{i}_link">
            <Attributes>
                <Table key="tcxs_download{i}">
                    ...
                    <Pair key="prod_pict_path"><String>/dev_hdd0/game/HANTOOLBX/USRDIR/IMAGES/ps3/{imagem}</String></Pair>
                </Table>
            </Attributes>
